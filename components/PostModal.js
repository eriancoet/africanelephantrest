...
const styles = {
    ...
    h-[40%} w-[50%] gap-[1rem] p-[1rem] justify-start
    m-auto font-mediumSerif overflow-scroll`,
...
const PostModal = () => {
    const { loggedInUser } = useContext(MyBlogContext)
    
    console.log(loggedInUser, 'user data')
