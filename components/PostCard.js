...
const styles = {
  wrapper: `flex max-w-[46rem] h-[10rem] items-center gap-[1rem] curser-pointer`,
  authorContainer: `flex gap-[.4rem]`,
  authorImageContainer: `grid rounded-full  overflow-hidden`,
...
const PostCard = ({post}) => {
  ...
  return (
    ...
    <div className={styles.authorName}>The African Elephant Restaurant</div>
    </div>
...
<div className={styles.detailsContainer}>
  ...
  <FiBookmark className='h-5 w-5' /></span>
      </div>
      </div>
